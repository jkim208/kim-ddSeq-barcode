...
def extract_barcode(line, ref_barcode_blocks, no_match, bad_anchor, bad_block, low_quality):
    ...
    return match_obj1, cell_bc, umi, no_match, bad_anchor, bad_block, low_quality
...
def read_and_write_sam(all_records, ref_barcode_blocks, output):
    ...
    for count, line in enumerate(originalSAM, start=0):
        ...
        if count % 2 == 0:
            ...
            match_obj1, cell_bc, umi, no_match, bad_anchor, bad_block, low_quality = extract_barcode(
                line, ref_barcode_blocks, no_match, bad_anchor, bad_block, low_quality)
    ...
    print("Bad anchors: " + bad_anchor)
    print("Bad blocks: " + bad_block)
    print("Low quality blocks: " + low_quality)
